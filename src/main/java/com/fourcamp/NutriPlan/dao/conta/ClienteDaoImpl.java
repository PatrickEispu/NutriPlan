...
public class ClienteDaoImpl implements ClienteDao {
    ...
    private static final String BUSCAR_CLIENTE_POR_ID = "SELECT * FROM public.buscar_cliente_por_id(?)";
    private static final String BUSCAR_TODOS_CLIENTES = "SELECT * FROM public.listar_todos_clientes()";
